 ...
 */
	...
	private class PlayFrequencyTask implements Runnable {
...
//										size, AudioTrack.MODE_STATIC);
			...
			if(pfa_on) handler.postDelayed(pft, 1000 * buffer.length / rate);
		}
	}
